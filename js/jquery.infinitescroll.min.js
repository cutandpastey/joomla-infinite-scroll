...
jQuery(document).ready(function () {
    jQuery(InfiniteConfig.container).infinitescroll({
        debug: true,
        behavior: undefined,
        binder: jQuery(window), // used to cache the selector for the element that will be scrolling
        nextSelector: 'a.infiniteScrollNextLink',
        navSelector: '.infiniteNavigation',
        ...
        path: function(p){
            ...
            console.log(InfiniteConfig.url);
            console.log(InfiniteConfig.limitStart);
            var url = InfiniteConfig.url + ((p - 1) * InfiniteConfig.limit);
            console.log(url);
            return url;
        }, // Can either be an array of URL parts (e.g. ["/page/", "/"]) or a function that accepts the page number and returns a URL
